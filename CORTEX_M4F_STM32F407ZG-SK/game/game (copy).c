...
//Player2
int16_t player2X = LCD_PIXEL_WIDTH - 10 ;
int16_t player2Y = LCD_PIXEL_HEIGHT - 10;
...
//Ball
uint16_t ballSize = 5;
int16_t ballX = ( LCD_PIXEL_WIDTH ) / 2 ;
int16_t ballY = ( LCD_PIXEL_HEIGHT ) / 2 ;
int16_t ballVX = 5;			//ball X speed
int16_t ballVY = 5;			//ball Y speed
uint8_t ballIsRun = 0;
